...
// "anyone" grants. DELIBERATELY NOT used for receipts/checklists (which
// Anton says already open fine) or passport photos/any other document --
// those must stay private, this is scoped narrowly to contracts only by
// which callers choose to invoke it, not by anything in this function
// itself, so double-check any new caller before reusing this. ----
